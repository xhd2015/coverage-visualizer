...
export function forEachLineMapping(changes: LineChange[], oldLines: number, newLines: number, fn: (oldLineStart: number, oldLineEnd: number, newLineStart: number, newLineEnd: number, changeType: ChangeType) => void) {
    ...
    for (let i = 0; i <= n; i++) {
        ...
        // unchanged lines
        fn(oldLineStart, oldLineEnd, newLineStart, newLineEnd, ChangeType.Unchange)
