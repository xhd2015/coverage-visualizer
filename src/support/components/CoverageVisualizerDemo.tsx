...
import { CoverageProfileFiles } from "../support/coverage"
import { LocalFileDetailGetter } from "../support/file"
...
export default function CoverageVisualizerDemo() {
    const [coverageFileList, setCoverageFileList] = useState(new CoverageProfileFiles(
        coverageData
    ))
    const [fileDetailGetter, setFileDetailGetter] = useState(new LocalFileDetailGetter({
        "main.go": { content: mainFile },
        "util/util.go": { content: utilFile },
    }))
    return <CoverageVisualizer fileList={coverageFileList} fileDetailGetter={fileDetailGetter} height="500px" />
}
